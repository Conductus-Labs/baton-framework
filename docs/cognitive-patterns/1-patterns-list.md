...
See [Using Patterns](2-using-patterns.md) for detailed guidance on pattern selection and configuration.

---

## Navigation

**Previous:** [0. Overview](0-overview.md) - Introduction to cognitive patterns  
