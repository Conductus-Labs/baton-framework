...
**To grant permission:**
Edit `.baton/workflows/workflow-permissions.yml` and add `{agent_short_name}` to the `allowed_agents` array under `permissions.manage-boundary-rule`.
